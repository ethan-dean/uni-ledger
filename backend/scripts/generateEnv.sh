...
: "${TEST_NETWORK_HOME:=../fabric-samples/test-network}"
...
: "${PRIVATE_KEY_FILE_ORG1:=$(ls ${TEST_NETWORK_HOME}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/*_sk)}"
...
: "${PRIVATE_KEY_FILE_ORG2:=$(ls ${TEST_NETWORK_HOME}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/*_sk)}"
